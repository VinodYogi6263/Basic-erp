...
import com.nrt.service.RoleService;
...
public class RoleServiceImpl implements RoleService {
	...
	public Role createRoleWithPermissions(String roleName, List<String> permissions) {
		...
		List<Permissions> addpermissions = permissionRepository.saveAll(createNewPermissions(permissions));

		for (Permissions permission : addpermissions) {
	...
	public Role addPermissionsToRole(String roleName, List<String> permissionNames) {
		...
		List<Permissions> permissions = permissionRepository.saveAll(createNewPermissions(permissionNames));
		role.getPermissions().addAll(permissions);

		return roleRepository.save(role);
	}

	private List<Permissions> createNewPermissions(List<String> permissionNames) {
